            ...
            popularProducts.forEach((product, index) => {
                ...
                card.innerHTML = `
                    ...
                    <div class="product-card__content">
                        ...
                        <a href="pages/product/product.html?id=${product.id}" class="product-card__link-overlay"></a>
                    </div>
                `;
            ...
            featuredFarmers.forEach(farmer => {
                ...
                card.innerHTML = `
                    ...
                    <div class="farmer-card__content">
                        ...
                        <a href="pages/farmers/farmers.html" class="farmer-card__link">Подробнее о фермере</a>
                    </div>
                `;
